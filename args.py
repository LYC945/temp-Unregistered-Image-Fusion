...
parser.add_argument('--vis_train_dir', default=r'/home/frank/Projects/MulFS-CAP/datasets/train_VIS', type=str)
parser.add_argument('--ir_train_dir', default=r'/home/frank/Projects/MulFS-CAP/datasets/train_IR', type=str)
parser.add_argument('--vis_test_dir', default=r'/home/frank/Projects/MulFS-CAP/datasets/RoadScene/test_VIS', type=str)
parser.add_argument('--ir_test_dir', default=r'/home/frank/Projects/MulFS-CAP/datasets/RoadScene/test_IR', type=str)
